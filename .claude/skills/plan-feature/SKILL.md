...
- Identify test framework and structure (vitest (packages), jest (api), etc.)
...
- `path/to/schema.ts` (lines 100-120) - Why: Database model structure to follow
- `path/to/feature.test.ts` - Why: Test pattern example

### New Files to Create

- `path/to/new-service.ts` - Service implementation for X functionality
- `path/to/new-schema.ts` - Data model for Y resource
- `tests/path/to/new-service.test.ts` - Unit tests for new service
