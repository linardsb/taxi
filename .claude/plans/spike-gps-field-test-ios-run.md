...
- 2026-08-31 (PR #138 review, F5/F11/F12) — Corrections to the line above. "Both need Xcode 26.4's compiler" is not observed: both fail on 26.3, and `expo-modules-jsi@57.0.5`'s changelog names a source bug for the first (`abs(_:)` "under newer toolchains", expo/expo#49039) and an Xcode 27 construct for the second (expo/expo#49120); no build on 26.4 ran. "Phases 1–3 dropped" overstates it: Phase 3 ran in deferral form (Tasks 3.0–3.3, 3.5). Task 3.6/AC7's closing keyword withdrawn — #4 stays open and the PR carries no closing reference.
