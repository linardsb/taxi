...
export const en = {
  ...
  'sms.driver_arrived_pin': 'Your taxi ({plate}) has arrived. PIN: {pin}',
  ...
  'console.map_alt':
    'Map of driver positions. The driver list with their status is below.',
  ...
  'console.drivers_title': 'Drivers',
  'console.drivers_empty': 'No drivers online',
  ...
  'driver.home.today': 'Settled today: {amount} · Rides: {rides}',
  ...
  'driver.offer.accepting': 'Accepting…',
  'driver.offer.revoked_taken': 'Another driver took this ride',
  'driver.offer.revoked_expired': 'The offer expired',
  'driver.offer.revoked_cancelled': 'The ride was cancelled',
  'driver.offer.a11y_card': 'New ride. Fare {amount}, you keep {net}.',
  ...
  'driver.ride.title_arrived': 'At pickup',
  'driver.ride.title_in_progress': 'Ride in progress',
  'driver.ride.pin_label': "Rider's PIN",
  'driver.ride.step_arriving': 'On my way',
  'driver.ride.step_arrived': 'I have arrived',
  'driver.ride.step_start': 'Start ride',
  'driver.ride.step_complete': 'Complete ride',
  'driver.ride.navigate_maps': 'Open Google Maps',
  'driver.ride.navigate_waze': 'Open Waze',
  'driver.ride.payment': 'Payment: {method}',
  'driver.ride.payment_changed':
    'The rider changed the payment method: {method}',
  'driver.ride.released': 'Dispatch reassigned this ride',
  'driver.ride.cancelled': 'Ride cancelled. {reason}',
  ...
  'driver.earnings.none_yet': 'No settled rides yet today',
  'driver.action.earnings': 'Earnings',
  'driver.error.offer_not_pending': 'This offer is no longer open',
  'driver.error.ride_not_accepted': 'The ride is no longer at «accepted»',
  'driver.error.ride_not_arriving': 'The ride is no longer at «on the way»',
  'driver.error.ride_not_arrived': 'The ride is no longer at «arrived»',
  'driver.error.ride_not_in_progress': 'The ride is no longer in progress',
  'driver.error.ride_transition_conflict': 'The status just changed. Reload.',
  'driver.error.ride_not_yours': 'This ride is not assigned to you',
  'driver.error.ride_not_found': 'Ride not found',
  'driver.error.pickup_pin_incorrect': 'Wrong PIN.',
  'driver.error.pickup_pin_locked': 'PIN locked. Call dispatch.',
  ...
  'rider.push.channel_name': 'Ride notifications',
