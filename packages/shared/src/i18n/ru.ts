...
export const ru = {
  ...
  'sms.driver_arrived_pin': 'Ваше такси ({plate}) на месте. PIN: {pin}',
  ...
  'driver.home.today': 'Рассчитано сегодня: {amount} · Поездки: {rides}',
  ...
  'driver.offer.a11y_card': 'Новый заказ. Цена {amount}, вы получаете {net}.',
  ...
  'driver.ride.pin_label': 'PIN-код пассажира',
  ...
  'driver.earnings.none_yet': 'Сегодня ещё нет рассчитанных поездок',
  ...
  'driver.error.pickup_pin_incorrect': 'Неверный PIN-код.',
  'driver.error.pickup_pin_locked': 'PIN заблокирован. Позвоните диспетчеру.',
  ...
  'rider.push.channel_name': 'Уведомления о поездке',
