...
| Driver app foundation | #14 | built (`feature/driver-app-auth-online-location`, 2026-08-31 — PR pending); Android/iOS field drives owed (#4 open; spike deferred 2026-08-26 → the app ships the mounted-phone superset design) | none |
